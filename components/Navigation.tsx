...
export default function Navigation() {
  ...
  return (
    <>
      <nav className="bg-white border-b border-green-200 shadow-sm sticky top-0 z-40">
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="px-4 py-2 bg-white border-2 border-emerald-200 rounded-full font-semibold text-emerald-700 hover:bg-emerald-50 hover:border-emerald-300 transition-all duration-200 hover:scale-105 text-sm hidden md:inline-block"
              >
                Agenda importeren
              </button>
